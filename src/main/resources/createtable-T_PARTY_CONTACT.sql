CREATE TABLE T_PARTY_CONTACT
   ...
   ROLE_TYPE NUMBER(1,0) NOT NULL, 
	...
	ROLE_TABLE VARCHAR2(30 BYTE),
	ROLE_SCN NUMBER(19,0),
	ROLE_COMMIT_SCN NUMBER(19,0),
	ROLE_ROW_ID VARCHAR2(18 BYTE),
	ADDR_SCN NUMBER(19,0),
	ADDR_COMMIT_SCN NUMBER(19,0),
	ADDR_ROW_ID VARCHAR2(18 BYTE)
) 
